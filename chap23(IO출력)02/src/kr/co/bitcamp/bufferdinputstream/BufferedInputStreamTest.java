package kr.co.bitcamp.bufferdinputstream;
...
public class BufferedInputStreamTest {
    ...
    File file =
            new File("C:\\Users\\bitcamp\\eclipse-workspace\\chap23(IO출력)02\\src\\kr\\co\\bitcamp\\bufferdinputstream\\We Never Go Alone.mp4");
     ...
     * 실질적으로 file을 읽어오는 주스트림이고, 읽어온 데이터를 빨리 처리해주는 역할이 바로 보조스트림인
     * BufferedInputStream 이다.
     */
