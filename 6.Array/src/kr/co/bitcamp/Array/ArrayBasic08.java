...
public class ArrayBasic08 {
    ...
    public static void main(String[] args) {
        ...
        String[] province = new String[3]; //배열 선언
        ...
        System.out.println(asiaNations[0]);     // 동북아시아 국가를 저장하고 있는 1차원 배열의 주소
        ...
        // charAt(int index) 메서드 사용 --> 해당 인덱스에 있는 값을 반환
